...
urlpatterns = [
    ...
    path('api', views.services_json, name='services_json'),
    ...
    path('hosts/<str:name>', views.hosts, name='hosts'),
    path('api/hosts/<str:name>', views.hosts_json, name='hosts_json'),
    path('type/<str:name>', views.by_type, name='by_type'),
    path('api/type/<str:name>', views.by_type_json, name='by_type_json'),
    path('command/<str:name>', views.command, name='command'),
