...
def ping(target, times=4):
    """ Borrowed from https://github.com/rogers0/shell_ping/blob/master/shell_ping.py
    ...
    try:
        pipe = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE,
                                shell=True).communicate(timeout=DEFAULT_TIMEOUT)[0]
...
if __name__ == '__main__':
    print(ping('srv-dev-002.local.domain'))
